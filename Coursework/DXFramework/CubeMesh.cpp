...
CubeMesh::CubeMesh(ID3D11Device* device, ID3D11DeviceContext* deviceContext, float size, XMFLOAT3 pos, int lresolution)
{
...
void CubeMesh::initBuffers(ID3D11Device* device, float size, XMFLOAT3 pos)
{
	VertexType* vertices;
